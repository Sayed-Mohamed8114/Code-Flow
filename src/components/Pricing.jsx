...
const plans = [
    ...
    },
    {
        name: "Enterprise",
        price: "199.99",
        description: "Built for large organizations at scale",
        features: [
            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    {plans.map((plan, key) => (
                        <div
                            ...
                            className={`relative bg-slate-900/50 
                                backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 
                                sm:p-8 transition-all duration-300 overflow-visible group flex flex-col h-full
                                ${plan.mostPopular
                        ...
                        >
                            ...
                            <div className="text-center mb-6 sm:mb-8">
                                <h3 className="font-bold text-xl sm:text-xl mb-2">{plan.name}</h3>
                                <p className="text-gray-400 text-sm sm:text-sm mb-3 sm:mb-4">{plan.description}</p>
                ...
                <div className="mt-8 sm:mt-12 text-center">
                    <p className="text-gray-400 text-base text-xl">
                        Need a custom plan? <a href="mailto:sayed.mohamed8114@gmail.com" className="text-blue-400 hover:text-blue-300">Contact our sales team</a>
                    </p>
                </div>
            </div>
        </section>
